...
function createVendingMachine() {
    ...
    function add25(){
        ...
        if (coins == 100){
            const randomElement = stock[Math.floor(Math.random() * stock.length)];
            coins =0;
            console.log(`You got some ${randomElement}`)
        }
        else{
            let remainingCoins = 100 - coins;
            console.log(`Insert ${remainingCoins} more coins`);
        }
